...
- Fully verified is 100% only when conversion is complete AND each component passes behavior checks against the original component flow.

## Progress Bars
- Conversion Progress: [######..............] 33% (5/15)
- Fully Verified Progress: [######..............] 33% (5/15)
...
|---|---|---|---|---|---|---|
| manager | virtManager/manager.py | ui/manager.ui | yes | yes | yes | yes |
| vm-window | virtManager/vmwindow.py | ui/vmwindow.ui | yes | yes | yes | yes |
| vm-details | virtManager/details/details.py | ui/details.ui | yes | yes | yes | yes |
| create-vm | virtManager/createvm.py | ui/createvm.ui | yes | yes | yes | yes |
| clone-vm | virtManager/clone.py | ui/clone.ui | yes | yes | yes | yes |
