...
- Web implementation evidence: testing/playwright/tests/machines.spec.mjs - Create VM workflow passes through wizard open, field updates, Back, Next, Finish, and Close. This is not reference verification.
